...
def main():
    ...
    generator = DataGenerator(data_dir='../dataset/train', batch_size=BATCH_SIZE, train_ratio=0.8, test_fold=5, band_opt=1, is_multi_resolution=is_multi_resolution) # band_opt: 0->14, 1->23, 2->9
